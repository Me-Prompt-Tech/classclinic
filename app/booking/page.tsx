...
return ( <main className="min-h-screen bg-gradient-to-br from-[#FAF7F2] via-[#FFFDF9] to-[#F5EEE3] py-10 px-6"> <div className="max-w-7xl mx-auto">
    ...
    <section className="glass p-14 mb-10 text-center">
      ...
      <h1 className="text-6xl md:text-7xl font-semibold gradient-text mb-5">
        CLASS CLINIC KORAT
      </h1>
      ...
      <div className="inline-flex mt-8 px-10 py-4 rounded-full bg-[#B8924F] text-white font-medium shadow-md">
